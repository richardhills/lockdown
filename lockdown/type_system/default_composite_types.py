...
#     UniversalListType, UniversalDictType
# from lockdown.utils import runtime_type_information
# 
# 
# READONLY_DEFAULT_OBJECT_TYPE = UniversalObjectType({}, name="readonly-default-object-type")
# READONLY_DEFAULT_LIST_TYPE = UniversalListType([], None)
# READONLY_DEFAULT_DICT_TYPE = UniversalDictType()
# 
